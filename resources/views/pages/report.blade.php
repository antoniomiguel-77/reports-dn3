...
<body>
    ...
    <div style="text-align:center; border:1px solid black;">
        ...
        <h4 style="text-decoration: underline">Tarefas Realizadas</h4>
            ...
            <table border="1" style="width: 44.2rem; border-collapse: collapse;text-align: center">
                <thead>
                    <tr>
        ...
        <h4 style="text-decoration: underline">Tarefas Pendentes</h4>
            ...
            <table border="1" style="width: 44.2rem; border-collapse: collapse;text-align: center; margin-bottom: 4rem">
                <thead>
                    <tr>
                        <th scope="col">Tarefa</th>
                        <th scope="col">Descrição</th>
                ...
                <div style="text-align: center">
                    ...
                    <span style="font-weight: bold; margin-left:2rem;">Data:__/_____/________</span>
                </div>
